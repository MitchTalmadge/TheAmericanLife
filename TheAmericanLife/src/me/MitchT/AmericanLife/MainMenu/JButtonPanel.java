...
public class JButtonPanel extends JPanel implements MouseListener
{
    ...
    private ArrayList<ButtonPanelListener> buttonPanelListeners = new ArrayList<ButtonPanelListener>();
    ...
    public JButtonPanel(BufferedImage menuIcons, int numberOfButtons)
    {
        ...
        {
            MenuButton button = new MenuButton(menuIcons, 375, 75, 0, 0+(150*i));
    ...
    public void mouseReleased(MouseEvent paramMouseEvent)
    {
        ...
        {
            if(menuButtons[i].equals((MenuButton) paramMouseEvent.getSource()))
                buttonId = i;
        }
